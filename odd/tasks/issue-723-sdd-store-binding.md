...
Integrate the reviewed ODD-723-03 resolver into status/continue source selection and expose persisted binding provenance in machine and human output. Keep protected-write routing, archive, #722 API/dashboard identity work, and #724 behavior out of this slice.
