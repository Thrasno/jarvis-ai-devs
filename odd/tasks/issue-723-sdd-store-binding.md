...
Implement the ODD-723-03 binding resolution/adoption state machine using the reviewed protected-progress observation contract, then integrate status/continue provenance separately. Do not add protected-write routing or #722/#724 behavior.
