...
Implement ODD-723-04B archive routing: executor-authored `archive-report` is the Hive logical-closure signal, OpenSpec retains validated rename, hybrid requires equivalent reports before rename, and no new closure state or archive receipt is introduced. Keep #722 identity/purge ownership and #724 supersession guards out of the slice.
