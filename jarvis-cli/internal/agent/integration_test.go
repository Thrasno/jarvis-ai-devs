...
func TestGeneratedRuntimeAcceptance_ConfigArtifactsProveRolloutSafety(t *testing.T) {
	...
	if err := openCode.MergeGeneratedConfig(defaultRuntimeConfig().PhaseModelsForState()); err != nil {
	...
	if err := claude.MergeGeneratedConfig(defaultRuntimeConfig().PhaseModelsForState()); err != nil {
