...
3. **CloudSQL JDBC — evidence retained only as excluded.** It requires the official JDBC driver and OAuth credentials and supports separately documented SQL behavior. CloudSQL JDBC is outside this routing and execution-contract snapshot.
