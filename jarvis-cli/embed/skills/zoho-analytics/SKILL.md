...
- Keep REST SQL export and persistent Query Tables distinct. CloudSQL JDBC is outside V0 routing, generation, and catalog scope.
...
3. Use an exact Deluge task for immediate row mutation from a verified host; use REST for reads, metadata, bulk, modeling, sharing, embed, users, and other cataloged operations.
...
3. Load only the relevant operation reference. Confirm writes before generation or execution.
...
- [REST v2 operation catalog](references/rest-v2-catalog.md)
