...
- Resolve project skills before launching agents: read the skill registry, match compact rules by target files/task, and inject the same `Project Standards` block into both judge prompts and fix prompts.
