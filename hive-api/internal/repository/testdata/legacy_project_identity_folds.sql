-- The two identity-derivation constructs that shipped to production, verbatim
...
-- fold present, the spelling registry present — and then prove migration 021
-- removes both. Seeding this by hand is the only way to reach that state, since
-- the migration files no longer create either object.
--
