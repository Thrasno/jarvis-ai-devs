...
export function renderKnowledgeBrowser(state: ViewState<KnowledgeDiscoveryData>, filters: string | URLSearchParams = window.location.search, options: { onNavigate?: (path: string) => void } = {}): HTMLElement {
